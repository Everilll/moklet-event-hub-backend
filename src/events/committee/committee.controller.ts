...
export class CommitteeController {
  ...
  @ApiOperation({ summary: '[PANITIA] Tambahkan anggota panitia/divisi baru ke dalam event' })
  ...
  @Roles('PANITIA')
  @ApiBearerAuth('access-token')
  @ApiOperation({ summary: '[PANITIA] Keluarkan anggota panitia/divisi dari event' })
  @ApiParam({ name: 'eventId', description: 'ID unik event' })
